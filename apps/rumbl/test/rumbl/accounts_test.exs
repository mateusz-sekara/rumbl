defmodule Rumbl.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "with invalid data does not inser user" do
  ...
  describe "authenticate_by_username_and_pass/2" do
    ...
    test "returns not found erro with no matching email" do
      assert {:error, :not_found} = Accounts.authenticate_by_username_and_pass("unknown_user", @pass)
    end
  end
end
